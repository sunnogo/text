...
`
	...
	copyExported("github.com/sunnogo/net/idna")
...
func copyExported(p string) {
	copyPackage(
		...
		"github.com/sunnogo/text/internal/export/"+path.Base(p),
		p)
}
...
func copyPackage(dirSrc, dirDst, search, replace string) {
	err := filepath.Walk(dirSrc, func(file string, info os.FileInfo, err error) error {
		...
		comment := "// Code generated by running \"go generate\" in github.com/sunnogo/text. DO NOT EDIT.\n\n"
		if *doCore {
			comment = "// Code generated by running \"go run gen.go -core\" in github.com/sunnogo/text. DO NOT EDIT.\n\n"
		}
